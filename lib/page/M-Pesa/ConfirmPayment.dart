                    ...
                    child: Center(
                      child: Padding(
                        padding: const EdgeInsets.all(20.0),
                          ...
                          child: Column(
                            children: [
                              Image.asset("MPesa.png", height: 100),
                              Center(
                                child: Text(
                                  "Confirm Payment",
                                  style: TextStyle(
                              ...
                              Center(
                                child: Padding(
                                  padding: const EdgeInsets.symmetric(horizontal: 70.0).add(EdgeInsets.only(top: 15)),
                                  child: Column(
                                    children: [
                                      Row(
                                        children: [
                ...
                child: Row(
                  children: [
                    GestureDetector(
                      onTap: (){
                        Navigator.of(context)
                            .push(MaterialPageRoute(builder: ((context) => paymentSuccessful())));
                    ...
                    GestureDetector(
                      onTap: (){
                        Navigator.of(context)
                            .push(MaterialPageRoute(builder: ((context) => paymentError())));
