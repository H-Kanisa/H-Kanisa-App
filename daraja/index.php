...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" ">
    ...
    <style>
      ...
      .store {
        background-color: #deca1b !important;
      }
    ...
    <div class="container d-flex justify-content-center">
      <div class="card mt-5 px-3 py-4">
        <div class="d-flex flex-row justify-content-around">
          ...
          <div class="store"><span><a href="https://store.hfc.life/"><font color="#ffffff" face="arial"><b>Go to HFC Store</b></font></a></span></div>
    ...
    document.getElementById("myText").value = total;
            ...
            <form class="row g-3" action="./stk_initiate.php" method="POST">
                ...
                <div class="col-12">
                  ...
                  <?php
                  $showspan="<span type=\"number\"  class=\"form-control\" id='total' name=\"amount\" ></span>";
                  echo "<p hidden>$showspan</p>";
                  ?>
                  <input type="number" class="form-control" id='myText' name="amount" value="" readonly>
